...
class Decoder:
    ...
    def decode_using_integers(self,
        ...
        while True:
            ...
            lower_bound_as_string = "{:05d}".format(lower_bound)
            upper_bound_as_string = "{:05d}".format(upper_bound)
            stop_loop = False
            while not stop_loop:
...
if __name__ == "__main__":
    ...
    result = "0341762830818000"
    decoded = decoder.decode_using_integers(message_to_decode=result)
