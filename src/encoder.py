            ...
            while not stop_loop:
                ...
                if lower_bound_as_string[0] == upper_bound_as_string[0]:
                    ...
                    if underflow_count != 0:
                        # chyba powinno być result += underflow_count
...
if __name__ == "__main__":
    ...
    result, _ = encoder.encode_using_integers(message_to_encode=message_to_encode)
    # decoded, _ = decoder.decode_using_integers(message_to_decode=result)
